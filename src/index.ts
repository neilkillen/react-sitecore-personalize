 ...
 * @param currency - The currency of the product added to the cart. Optional
 ...
 */
export function sendAddEvent(page:string,productType:string, itemId: string, productName:string, productId:string, orderDate:string, qty:number, price:number, referenceId:string, currency?:string, originalPrice?:number, originalCurrencyCode?:string) {
    if(!window._boxever) return
    window._boxeverq.push(function() {
